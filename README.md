...
- You can pull this code and host on your own Cloud Instance (e.g. Google App Engine or AWS Elastic Beanstalk) using Python Flask (search Google for tutorials)
